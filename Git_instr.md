...
5. Переимновать ветку на ходясь в ветке master можно осуществить - `git branch -m "formatting_8" "formatting"`. Если понадобиться переименовать текущую ветку - `git branch -m "Новое название текущей ветки"` 
